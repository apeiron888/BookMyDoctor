...
const specialityMenu = () => {
  ...
  return (
    <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-gray-800'>
      ...
      <p className='sm:w-1/3 text-center text-sm'>{t('Simply browse through our extensive list of trusted doctors, schedule your appointment hassle-free.')}</p>
